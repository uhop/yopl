// bench-proof-loop.js workloads through the LP-specialized unifier
// (src/solve-lp.js). Same variant names so `nano-bench-compare` pairs them
// against a saved bench-proof-loop.js run. Run with
// `npm run bench -- bench/bench-proof-loop-lp.js`.

import {variable as v} from 'deep6/env.js';
import solve from '../src/solve-lp.js';
