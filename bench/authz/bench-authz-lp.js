// bench-authz.js op mix through the LP-specialized unifier
// (src/solvers/gen-lp.js). Same org (seeded), same query sets, same variant
// names — `nano-bench-compare` pairs this against the saved baseline run.
// Record with `npm run bench -- bench/authz/bench-authz-lp.js -i 500 --json ...`.

import gen from '../../src/solvers/gen-lp.js';
