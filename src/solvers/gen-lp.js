// @ts-self-types="./gen-lp.d.ts"
// gen() with the proof loop's inner unify swapped for the LP-specialized
// unifier — experiment entry per dev-docs/authz-bench.md § Measurements.
// Baseline src/solvers/gen.js stays untouched (dev-docs/implementation-discipline.md).
