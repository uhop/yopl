// @ts-self-types="./solve-lp.d.ts"
// solve() with the proof loop's inner unify swapped for the LP-specialized
// unifier — experiment entry per dev-docs/authz-bench.md § Measurements.
// Baseline src/solve.js stays untouched (dev-docs/implementation-discipline.md).
